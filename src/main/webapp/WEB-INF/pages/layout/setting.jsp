...
<script type="text/javascript" src="res/js/collapse.js"></script>
     ...
     <!--  <link rel="stylesheet" type="text/css" href="res/datatable/datatables.min1.css"/>  -->
  <link rel="stylesheet" type="text/css" href="..res/datatable/jquery.dataTables.min.css"/>
   
      <link rel="stylesheet" type="text/css" href="res/datatable/dataTables.bootstrap.min.css"/> 
       <link rel="stylesheet" href="res/datatable/buttons.dataTables.min.css"/> 
 <link rel="stylesheet" type="text/css" href="res/datatable/fixedHeader.dataTables.min.css"/>
