...
<script type="text/javascript" src="../res/js/hoantra/002.js"></script>
...
<body onload="startTime()">
	<!-- page -->
		...
		<div style="float: left">
	               <h4><strong>Cân và in tem hàng trả lại</strong></h4>
	                 </div>
			<div class="row">
				<!-- header -->
				<div class="col-sm-2">
	...
	<div class="headerright">
		  ...
		  <sec:authorize access="hasRole('ROLE_ADMIN')" >
			...
			<a id="" href="admin/controlPanel" class="btn btn-link"><span class="glyphicon glyphicon-home"></span>Admin</a>
					</sec:authorize>
					 <a href="<c:url value="/return/" />" ><span class="glyphicon glyphicon-home"></span>Form nhập</a>
		     <a href="<c:url value="/return/listreturn" />" ><span class="glyphicon glyphicon-list-alt"></span>In lại, xóa</a>
